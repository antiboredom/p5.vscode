...
curl -s https://api.github.com/repos/processing/p5.js/releases/latest | grep "browser_download_url.*download.*p5.js" | cut -d : -f 2,3 | tr -d \" | wget -i - -O template/libraries/p5.js
